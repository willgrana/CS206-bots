...
class NEURON: 
    ...
    def Allow_Presynaptic_Neuron_To_Influence_Me(self, synapse_weight, neuron_value):
        val = synapse_weight*neuron_value
        self.Add_To_Value(val)
        pass

    def Update_Sensor_Neuron(self, body):
        self.Set_Value(pyrosim.Get_Touch_Sensor_Value_For_Link(self.Get_Link_Name(),body))

    def Update_Hidden_Or_Motor_Neuron(self, neurons, synapses):
        self.Set_Value(math.pi/8.0)
        #print(neurons.Get_Value())
        for key in synapses:
